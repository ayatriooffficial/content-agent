...
function startScheduler() {
  // Local instances disable the auto-scheduler so they never double-trigger
  // alongside the deployed instance (both share the same MongoDB).
  if (process.env.SCHEDULER_ENABLED === "false") {
    console.log("🕐 Autonomous scheduler DISABLED (SCHEDULER_ENABLED=false). Manual triggers still work.");
