...
router.patch("/whatsapp/:id/status", async (req, res) => {
  ...
  try {
    ...
    // TODO: once a real WhatsApp Business API integration exists, trigger
    // the actual send here when finalStatus === "published", the same way
    // the root email-bot sends approved EmailCampaign docs.
