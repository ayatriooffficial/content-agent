...
Output EXACTLY this JSON structure (no extra text):
{
  ...
  "affordabilityConcerns": ["how they think about the program fee and investment — EMI financing? family approval? career investment vs risk?"],
  ...
  if (!resultJSON) {
    ...
    resultJSON = {
          ...
          affordabilityConcerns: ["Program fee feels like a commitment for the family", "Manageable with flexible EMI", "Needs family approval", "Seen as career investment if ROI is clear"],
          ...
          objectionsBeforePurchase: { exactObjections: ["Will this really get me a job?", "Is placement support genuine?", "Is the program investment worth it?"], triggerEvents: "Graduation approaching, seeing peers get placed", evaluationCriteria: "Placement proof, practical curriculum, salary outcomes, cost" },
