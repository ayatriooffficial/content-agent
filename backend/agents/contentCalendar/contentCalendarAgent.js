...
10. REAL DATA & ZERO FAKE NAMES (STRICT): When creating story-driven or case-study titles/subjects/hooks, you must ONLY use real student names from REAL STUDENT STORIES in the LIVE WEBSITE DATA (or use role/institutional transformation framing like "From B.Com graduate to corporate accountant: The 7-month path"). NEVER invent fictional names (e.g. "Sudipta", "Rahul", etc.). Every student, faculty member, curriculum module, and recruiter name in every title, subject line, or hook MUST come directly from the LIVE WEBSITE DATA.`;
